...
syntax match kplInteger /\<\d\+\>/
syntax match kplInteger /[-+]\d\+/
syntax match kplHex /0x\x\+/
syntax match kplFloat /[-+]\=\d*\.\d\+/
...
" Block Definitions
syntax keyword kplKeyword new extends messages implements superclass fields uses renaming to const var errors type enum returns asInteger asPtrTo arraySize isInstanceOf isKindOf alloc sizeOf function[s] external endFunction infix prefix method[s] endMethod
